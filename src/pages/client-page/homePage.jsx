...
function HomePage() {
    ...
    return (
        <>
            <Header/>
            <div className="w-full h-screen bg-fuchsia-200">
                <div className="relative flex justify-center my-[70px] font-bold">
                ...
                <div className="relative flex justify-center my-[80px]">
