...
function EditGallery(props){
    ...
    function updateGallery(){
        axios.put(import.meta.env.VITE_BACKEND_URL+"/api/gallery/"+name,imageItem,{
            headers:{
        ...
        <>
            <div className="flex h-screen w-full bg-white">
                <div
                    ...
                    <div className="flex">
                        <h3 className="text-xl font-bold mb-6 text-center w-full h-10 rounded-2xl">Edit Gallery</h3>
                        <button onClick={()=>{
                            closeModel();
                        }}
