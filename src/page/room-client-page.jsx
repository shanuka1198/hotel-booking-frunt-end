...
import RoomClientPageImageSlide from "../component/room-client-page-image-slide.jsx";
        ...
        <>
            <div className=" w-full max-h-full">
                ...
                <div className="flex flex-row">
                        ...
                        {rooms.map((room, index) => (
                            <div key={index}
                                ...
                                <div className="relative w-[350px] h-[250px]">
                                   <RoomClientPageImageSlide photo={room}/>
                                    <button
                    ...
                    <div className="p-4 bg-fuchsia-700 bg-opacity-50 shadow shadow-black  rounded-xl flex right-1 flex-col">
                            <div
